...
//KILL EVENT LISTENERS AND DISPLAY RESULTS
    ...
    localStorage.setItem('chart', JSON.stringify(productsArray))
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: [array[0].product, array[1].product, array[2].product, array[3].product, array[4].product, array[5].product, array[6].product, array[7].product, array[8].product, array[9].product, array[10].product, array[11].product, array[12].product, array[13].product, array[14].product, array[15].product, array[16].product],
        datasets: [{
            label: '# of Votes',
            data: [array[0].votes, array[1].votes, array[2].votes, array[3].votes, array[4].votes, array[5].votes, array[6].votes, array[7].votes, array[8].votes, array[9].votes, array[10].votes, array[11].votes, array[12].votes, array[13].votes, array[14].votes, array[15].votes, array[16].votes],
            borderWidth: 1
        }]
    },
    options: {
...
productsArray = JSON.parse(localStorage['chart']);
results(productsArray);
} else {
displayImg();
}
